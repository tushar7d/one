      ...
      <ScrollContainer>
        ...
        >
          <Stack vertical center mid p="3" bg="white" mb="3" borderRadius="2">
            <Image src={offer[props.id].image} maxWidth="150px" mb="2" />
            <Image
          ...
          <Stack vertical left top p="3" bg="white" mb="3" borderRadius="2">
            <Text type500 bold color="neutral__900" mb="2">
              Pick-up & Drop-off
            </Text>
          ...
          <Stack vertical left top p="3" bg="white" mb="3" borderRadius="2">
            ...
            <Text type300 regular color="neutral__700">
            Driver under 30 or over 70 years of age may need to pay an extra fee. 
            </Text>
          </Stack>
